...
# ------------------------------------------------------------------------------------------- #
# modification made by Luheng (Wesley) Wang on 13:46 2021/4/17 CST
# ------------------------------------------------------------------------------------------- #
from task_def import TaskType
from task_def import EncoderModelType
...
class SmartPerturbation():
    ...
    def forward(self, model,
        ...
        for step in range(0, self.K):
            ...
            vat_args = [input_ids, attention_mask, premise_mask, hyp_mask, task_id, 2, embed + noise]
        ...
        adv_loss = stable_kl(logits, adv_logits, ignore_index=-1)
